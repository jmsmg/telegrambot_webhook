...
class Bot:
    ...
    def get_me(self):
        ...
        """
        return self._check_response(_BASE_URL + "getMe")
    ...
    def set_webhook(self, webhook_url):
        ...
        Refer to https://jwkcp.github.io/2018/03/09/telegram-bot-api-response-json/ (In Korean)
        """
        return self._check_response(_BASE_URL + "setWebhook", webhook_url)
    ...
    def delete_webhook(self):
        ...
        Refer to https://jwkcp.github.io/2018/03/09/telegram-bot-api-response-json/ (In Korean)
        """
        return self._check_response(_BASE_URL + "deleteWebhook")
    ...
    def send_message(self, event, msg, chat_id=None, webhook_url=None, parse_mode=None, disable_web_page_preview=None, disable_notification=None, reply_to_message_id=None, reply_markup=None):
        """
        ...
        res = requests.get(_BASE_URL .format(token=self.__token) + "sendmessage", params=params)
